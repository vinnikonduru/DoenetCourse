      ...
      {tobeRenderedChildren ? tobeRenderedChildren.map((obj,index)=> {
        ...
        <div> 
          ...
          <>
            ...
            {isOpen ? <MinimizedSection style={{left: leftPos ? leftPos : 0, position:"absolute"}}>{minimizedItemIndex !==-1 ? defaultChildrens[minimizedItemIndex] : ""} </MinimizedSection> : false}
          </> : 
